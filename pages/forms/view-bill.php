          ...
          <div class="mdc-layout-grid__inner">
			   ...
			   <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
				...
				<div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6-desktop">
				  <div class="template-demo">
					<div id="demo-tf-box-wrapper">
						<p class="control-label col-sm-10 details"><b>CGST(9%) : </b><span><?php $cgst = round($sub_total*0.09, 2); echo $cgst;?></span></p>
					</div>
				  </div>
				</div>
				<div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6-desktop">
				  <div class="template-demo">
					<div id="demo-tf-box-wrapper">
						<p class="control-label col-sm-10 details"><b>SGST(9%) : </b><span><?php $sgst = round($sub_total*0.09, 2); echo $sgst; ?></span></p>
					</div>
				  </div>
				</div>
				<div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-6-desktop">
